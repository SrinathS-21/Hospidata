    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Hospidata, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Hospidata, you agree to our Terms of Service. This
          includes guidelines for using our platform, interacting patients and doctors,
        ...
        <p className="legal-description">
          Hospidata is designed to simplify healthcare access. You can upload
          your medical records and schedule an appointment both virtual as well as direct consultation. 
          There exist medical record transparency and so treatment
          plans are tailored to your needs. Please remember that emergencies require
      ...
      <div className="legal-footer">
        <p>© 2024 Hospidata. All rights reserved.</p>
      </div>
    </div>
  );
}
