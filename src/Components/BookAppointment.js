...
import Doctor from "../Assets/secure.png";
    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        ...
        <p className="ba-description">
          Discover the reasons to choose Hospidata for your healthcare needs.
        ...
        <p className="ba-checks ba-check-first">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> Enhance treatment decisions
        </p>
